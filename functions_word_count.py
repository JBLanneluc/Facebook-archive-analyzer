...
def phone_number_extractor(message, https):
    ...
    while k + 2 < len(message):
        ...
        if (message[k] == "+" and message[k + 1] in digits and message[k + 2] in digits) or (
                message[k] in digits and message[k + 1] in digits):
...
def clean_irrelevant_words(words_list):  # marche pas bien parce que nettoie dans la string => à refaire
    irrelevant_words = ['je', 'est', "c'est", "c’est", "j’ai", "j'ai", "comme", 'tu', 'de', 'pas', 'c', 'et', 'que',
                        'en', 'le', 'la', 'ça', 'à', 'j', 'les', 'un', 'mais', 'pour', 'l', 'ai', 'du', 'des', 'il',
                        'on', 'bien', 'd', 'une', 'a', 'ce', 'me', 'qu', 'fait', 'elle', 'oui', 'plus', 'as', 'si',
                        'moi', 'au', 'avec', 'sur', 't', 'ou', 'qui', 'dans', 'ah', 'quand', 'faire', 'non', 'm',
                        'tout', 'mon', 'coup', 'suis', 'quoi', 'bon', 'trop', 'était', 'y', 'x', 'se', 'va', 'sais',
                        'là', 'es', 'même',
                        'veux',
                        'aussi',
                        'être',
                        ...
                        'peu',
                        'dire',
                        'très', 'fais', 'the', 'ils', 'faut', 'juste', 'comment', 'ma', 'son', 'après', 'vrai', 'donc',
                        'ne', 'tous', 'mieux', 'dit', 'voir', 'pense', 'peut', 'avais', 'mes', 'tes', 'fois', 'n', '=',
                        'vous', 'parce', 'sa', '', 'déjà', 'chez', 'cette', 'dis', 'marche', 'avait', 'sinon', 'bcp',
                        'of', 'to', 'alors', 'avant', 'puis', 'vas', 'temps', 'crois', 'vraiment', 'votre', 'ahh',
                        'nous', 'avoir', 'cas', 'sont',
                        'rien',
                        'vu',
                        '+',
                        ...
                        'vois',
                        'encore',
                        'mal', 'demain', 'où', "qu'il", "qu'elle", "qu'on", 'ont', 'moins', 'pourquoi', 'depuis',
                        "d'ailleurs", 'bonne', 'vient', 'autre', 'enfin', 'aller', 'dois', 'sûr', 'petit', 'quel',
                        'maintenant', 'soit', 'eu', 'surtout', 'gens', 'nan', 'sans', 'tant', 'autres', 'ok', 'ces',
                        'besoin', 'connais', 'sens', 'jamais', 'passe', 'haha', 'vie', 'imagine', 'cet', 'aux', 'au',
                        "j'avais", "qu'est", "j'aime", "ment", "nais", "côté", "coté", "cote", "parle",
                        "mettre",
                        "met",
                        "mett",
                        'j’aime',
                        ...
                        "partie",
                        "soir",
                        "com/watch", "entre", "s'est", "l'impression", "effet", "parler", "plein", "penses",
                        "assez" "serait", "l'ai", "long", "longtemps", "pris", "question", "manqué", "part", "normal",
                        "nant", "hier", "nais", "main", "bref", "message", "plutôt", "donne", "tiens", "trouve",
                        "trouves", "heure", "encore", "souvent", "sera", "enco", "j'espè", "t'en", "t'as", "vers",
                        "leur", "leurs", "voila", "voilà", "choses", "chose",
                        "m'en",
                        "beaucoup",
                        "d'un",
                        "d'une",
