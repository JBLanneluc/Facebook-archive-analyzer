...
print(ASCII)
print("---------------------------------------------------\n")
print("Bienvenue sur notre programme d'analyse messenger. \nNous allons analyser votre archive facebook et en extraire des statistiques à titre informatif. Soyez rassuré, ces statistiques ne seront visibles que par vous-même, et en aucun cas elles ne seront envoyées ou stockées ailleurs.")
